...
class Softmax(object):
  ...
  def fast_loss_and_grad(self, X, y):
    ...
    # Compute gradient
    probabilities[np.arange(N), y] -= 1  # Subtract 1 for correct class probabilities
  ...
  def predict(self, X):
    ...
    probabilities = np.exp(all_scores)/np.sum(np.exp(all_scores), axis = 1, keepdims = True)
    y_pred = np.argmax(probabilities, axis = 1) #y_pred should be a 1 dim array of length N
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
